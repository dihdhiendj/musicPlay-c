/****************************************************************************
** Meta object code from reading C++ file 'addlib.h'
**
...
#error "The header file 'addlib.h' doesn't include <QObject>."
...
#ifdef QT_MOC_HAS_STRINGDATA
struct qt_meta_stringdata_CLASSupENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSupENDCLASS = QtMocHelpers::stringData(
    "up"
);
#else  // !QT_MOC_HAS_STRINGDATA
#error "qtmochelpers.h not found or too old."
...
Q_CONSTINIT static const uint qt_meta_data_CLASSupENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject up::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_CLASSupENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSupENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSupENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<up, std::true_type>
    >,
    nullptr
} };

void up::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    (void)_o;
    (void)_id;
    (void)_c;
...
const QMetaObject *up::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *up::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_CLASSupENDCLASS.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int up::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{

...
constexpr auto qt_meta_stringdata_CLASSlistENDCLASS = QtMocHelpers::stringData(
    ...
    "musicCore*",
    "askFreeMusic",
    "on_pushButton_high_clicked",
    "on_pushButton_tables_clicked"
);
...
Q_CONSTINIT const QMetaObject list::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSlistENDCLASS_t,
        ...
        // method 'askFreeMusic'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_pushButton_high_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_pushButton_tables_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void list::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->playMusic((*reinterpret_cast< std::add_pointer_t<musicCore*>>(_a[1]))); break;
        case 1: _t->askFreeMusic(); break;
        case 2: _t->on_pushButton_high_clicked(); break;
        case 3: _t->on_pushButton_tables_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (list::*)(musicCore * );
            if (_t _q_method = &list::playMusic; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (list::*)();
            if (_t _q_method = &list::askFreeMusic; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void list::playMusic(musicCore * _t1)
{
